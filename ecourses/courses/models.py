...
class Course(ModelBase):
    ...
    tags = models.ManyToManyField('Tag', blank=True, related_name='course', null=True)
...
class Message(models.Model):
    ...
    def __str__(self):
        return str(self.user) + ' Said ' + str(self.mess) + ' in group chat ' + str(
            self.group_chat) + ' at time: ' + str(self.date_post)
